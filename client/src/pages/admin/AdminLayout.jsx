    ...
    <>
      ...
      <div className="pt-16 md:pt-20 min-h-screen flex">
        ...
        <button
          ...
          className="md:hidden fixed bottom-6 right-6 z-40 w-12 h-12 bg-neon text-dark rounded-full flex items-center justify-center shadow-neon"
        >
        ...
        {/* Sidebar */}
        <aside
          className={`fixed md:sticky top-16 md:top-20 left-0 z-30 h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)] w-64 bg-dark-card border-r border-dark-border flex flex-col transform transition-transform duration-300 ${
